...
- **Presupuesto: 15-25 turnos, tres niveles.** ⏱ 15 = chequeo: ¿misma tarea? si sí, seguí; si cambió el tema, handoff y `/clear`. ⏱ 25 = cerrás en el próximo hito. ⏱ 35 y siguientes = cerrás ahora aunque quede a medias, con el handoff diciendo dónde retomar. Si la statusline marca contexto > 50%, es hora de cerrar aunque el contador no haya avisado. Una tarea a medias con estado escrito se retoma barata; una sesión de ochenta turnos no se retoma, se paga.
