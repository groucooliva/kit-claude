...
| `v2/plantillas/` | Dos plantillas de estructura: `CLAUDE_raiz_de_trabajo.md` (el router de la carpeta raíz, con el mapa de carpetas y la higiene de archivos) y `CLAUDE_brain.md` (gobernanza del segundo cerebro: notas planas, wikilinks, índice, ingest diferencial). |
| `skills/` | Once skills, una carpeta con su `SKILL.md` cada una. Se disparan solas por sus disparadores. |
